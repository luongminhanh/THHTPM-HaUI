...
namespace LuongMinhAnh_call
{
    public partial class Form1 : Form
    {
        ...
        public void loaddgv()
        {
            string link = "http://localhost:91/hocrestful6/api/nhanvien";
        ...
        {
            string link = string.Format("http://localhost:91/hocrestful6/api/nhanvien?ma={0}&ten={1}&trinhdo={2}&luong={3}", 
        ...
        {
            string link = string.Format("http://localhost:91/hocrestful6/api/nhanvien?ma={0}",
                txtMa.Text, txtTen.Text, txtTrinhDo.Text, txtLuong.Text);
            HttpWebRequest request = WebRequest.CreateHttp(link);
